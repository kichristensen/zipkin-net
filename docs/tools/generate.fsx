...
let website = "/zipkin-net"

let githubLink = "https://github.com/kichristensen/zipkin-net"

// Specify more information about your project
let info =
  [ "project-name", "zipkin-net"
    "project-author", "Kim Christensen"
    "project-summary", "A Zipkin tracer for .NET"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/zipkin-net" ]
